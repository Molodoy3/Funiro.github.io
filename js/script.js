...
//# sourceMappingURL=swiper-bundle.js.map; */
    ...
    //Поиск
    const iconSearchForm = document.querySelector('.search-form__icon');
    const bodySearchForm = document.querySelector('.search-form__item')
    if (iconSearchForm) {
        iconSearchForm.addEventListener("click", function () {
            bodySearchForm.classList.toggle("active");
            iconBurger.classList.remove('active');
            bodyBurger.classList.remove('active');
        });
    }
    ...
    if (document.querySelector('.slider-main__body')) {
        new Swiper('.slider-main__body', {
            ...
            preloadImages: false,
            pagination: {
                el: '.controrl-slider-main__dotts',
                clickable: true,
            },
            navigation: {
                nextEl: '.arrows-main-slider__arrow_next',
                prevEl: '.arrows-main-slider__arrow_prew',
            }
        });
    }
    //rooms-slider
    if (document.querySelector('.slider-rooms')) {
        new Swiper('.slider-rooms', {
            wrapperClass: 'slider-rooms__wrapper',
            slideClass: 'slider-rooms__slide',
            observer: true,
            direction: "horizontal",
            observeParents: true,
            observeSlideChildren: true,
            ...
            navigation: {
                nextEl: '.arrows-slider-rooms__arrow_next',
                prevEl: '.arrows-slider-rooms__arrow_prew',
            },
            breakpoints: {
                767.98: {
                    slidesPerView: "auto",
    ...
    if (document.querySelector('.slider-tricks')) {
        new Swiper('.slider-tricks', {
            wrapperClass: 'slider-tricks__wrapper',
            slideClass: 'slider-tricks__slide',
            observer: true,
            direction: "horizontal",
            observeParents: true,
            observeSlideChildren: true,
            slidesPerView: 3,
            slideActiveClass: 'slider-slide_active',
            spaceBetween: 26,
            watchOverflow: false,
    ...
    //делегирование события click для подгрузки блоков, добавления товара в корзину
    ...
    function documentActions(e) {
        ...
        if (targetElement.classList.contains('cart-header__icon') || targetElement.closest('.cart-header__icon')) {
            if (document.querySelector('.cart-list').children.length > 0) {
                document.querySelector('.cart-list').classList.toggle('active');
            }
            e.preventDefault();
        }
        ...
        if (targetElement.classList.contains('cart-list__delete')) {
            const productId = targetElement.closest('.cart-list__item').dataset.pid;
    ...
    function LoadProducts(data) {
        const productItem = document.querySelector('.products__row');
        ...
        data.products.forEach(item => {
            ...
            let productTemplateStart = `<article data-pid="${productId}" class="products__item item-product"><div class="item-product__wrapper">`;
            ...
            if (productLabels) {
                ...
                productLabels.forEach(labelItem => {
                    productTemplateLabelsContent += `<div class="item-product__info item-product__info_${labelItem.type}">${labelItem.value}</div>`;
                });
		...
		<div href="${productUrl}" class="item-product__image">
	...
	`;
			...
			<div class="item-product__label">${productText}</div>
	`;

            let productTemplatePrices = '';
            let productTemplatePricesStart = `<div class="item-product__value">`;
            let productTemplatePricesCurrent = `<div class="item-product__price">Rp ${productPrice}</div>`;
            let productTemplatePricesOld = `<div class="item-product__price item-product__old-price">Rp ${productOldPrice}</div>`;
		...
		<div class="item-product__hover hover-product">
				<a href="" class="hover-product__button btn">Add to cart</a>
                <div class="hover-product__links">
                <a href="${productShareUrl}" class="hover-product__link">
                ...
                <a href="${productLikeUrl}" class="hover-product__link">
	...
	`;
            ...
            productItem.insertAdjacentHTML("beforeend", productTemplate);
        });
    }
    ...
    //Сам список товаров в корзине
    function updateCart(productButton, productId, productAdd = true) {
        const cart = document.querySelector('.cart-header');
        const cartIcon = cart.querySelector('.cart-header__icon');
        const cartQuntity = cartIcon.querySelector('span');
        const cartProduct = document.querySelector(`[data-pid="${productId}"]`);
        const cardList = document.querySelector('.cart-list');

        if (productAdd) {
            if (cartQuntity) {
                cartQuntity.innerHTML = ++cartQuntity.innerHTML;
            } else {
            ...
            `;
                cardList.insertAdjacentHTML("beforeend", `<li data-card-pid=${productId} class="cart-list__item">${cartProductContent}</li>`);
            } else {
            ...
            const cartQuntityValue = --cartQuntity.innerHTML;

            if (cartQuntityValue) {
                cartQuntity.innerHTML = cartQuntityValue;
            } else {
                cartQuntity.remove();
    ...
    if (furniture && !(/Android|webOS|iPhone|iPad|iPod|BlackBerry|BB|PlayBook|IEMobile|Windows Phone|Kindle|Silk|Opera Mini/i
        .test(navigator.userAgent))) {
